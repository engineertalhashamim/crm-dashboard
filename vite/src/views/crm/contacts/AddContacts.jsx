        ...
        <Grid container spacing={2}>
          ...
          <Stack spacing={2} direction="row" marginTop={0} sx={{ width: '100%' }}>
            ...
            <FormControl fullWidth sx={{ width: '49%' }} error={!!error?.direction}>
              ...
              <Select labelId="direction-label" id="direction" name="direction" value={contactForm.direction} onChange={handleChanged}>
              ...
              {error?.direction && <FormHelperText>{error.direction}</FormHelperText>}
            </FormControl>
          </Stack>
